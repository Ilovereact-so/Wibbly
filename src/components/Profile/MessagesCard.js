...
const MessagesCard = () => {
  return (
    <div id="promt" className='w-full h-auto min-h-[450px] pt-[20px] rounded-[50px] mb-[50px]'>
      <div className='flex flex-col w-full h-full justify-between'>
        ...
        <form className='w-full h-auto bg-white flex justify-center rounded-full'>
            ...
            <button type="submit" className='min-w-[45px] h-auto bg-[#777777] rounded-full my-3 mr-6 flex items-center justify-center hover:brightness-75 cursor-pointer'><i className='gg-arrow-down rotate-[-90deg] scale-[0.9] text-white'></i></button>
        </form>
      </div>
    </div>
  )
