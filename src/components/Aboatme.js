...
const Aboatme = ({r}) => {
  ...
  return (
  <div id='ABMain' ref={r} className={`flex ease-in-out duration-300 z-[2] relative ${
    slide ? "translate-x-[-100%]":"translate-x-0"
  }`}>
      <div className='lg:h-[130vh] h-auto xl:h-[100vh]'>
        <div style={{backgroundColor: Pallete[2]}} className='h-full w-[100vw] flex xl:flex-row flex-col relative'>
          ...
          <div className='lg:my-[200px] my-0 mb-[200px] xl:mt-[300px] lg:mt-28 mt-0 xl:pb-0 pb-20 xl:h-auto ss:h-[50vh] h-[30vh] flex justify-center w-full relative xl:static px-8 md:px-16 ss:px-14  lg:ml-8'>
            ...
            <div className='flex items-start h-full relative z-[2] 2xl:mr-12 xl:mr-5 md:mr-12 ss:mr-6 mr-4 lg:w-auto w-full'>
              <div style={{backgroundColor: Pallete[1]}} className='2xl:w-[390px] lg:w-[390px] w-full xl:w-[320px] lg:h-[320px] md:h-[228px] ss:h-[188px] h-[148px] ease-in-out duration-300  levitationS lg:rounded-[40px] rounded-[20px] lg:px-11 md:px-12 px-4 lg:pt-10 pt-4 pb-6 flex flex-col'>
      ...
      <div className='xl:h-[100vh] lg:h-[130vh] h-auto bg-[#F6F7F8]'>
          <div className='h-full w-[100vw] flex xl:flex-row flex-col  relative '>
            ...
            <div style={{backgroundColor: Pallete[2]}} className={`overflow-hidden ease-in-out duration-700 z-10 2xl:px-32 xl:px-24 md:px-44 px-6 md:mx-0 mx-16 md:w-auto w-full opacity-[0.7] pt-0 rounded-t-[50px] flex justify-around items-center flex-col ${
